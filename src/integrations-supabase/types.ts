    ...
    Tables: {
      ...
      members: {
        Row: {
          ...
          consultancy_available: boolean;
          consultancy_currency: string;
          consultancy_description: string | null;
          consultancy_rate: number | null;
      ...
      priority_subscriptions: {
        ...
        Relationships: [
          {
            foreignKeyName: 'priority_subscriptions_member_id_fkey';
            columns: ['member_id'];
            isOneToOne: false;
            referencedRelation: 'members';
            referencedColumns: ['id'];
